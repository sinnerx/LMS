 ...
 //  $this->load->model('data');
  ...
  function index()
    ...
    //$trainingType = ;      
      $data = array(
       ...
       $data['type'] = $this->courses_data->getAllTypes();
      $data['page_title'] = 'Learning Management System';
      $data['nav_title'] = 'Course';
  ...
  //  }
    ...
    $userLevel = $this->nativesession->get( 'userLevel' );
      ...
      $data = array(
        ...
        $data['course'] = $this->coursedata->id($id);
        $data['type'] = $this->courses_data->getAllTypes();
        $data['subtype'] = $this->courses_data->getSubTypes($data['course']['typeid']);
        //var_dump($data['course']['typeid']);
        //var_dump($data['subtype']);
        //die;
  ...
  function delete($id)
    ...
    $userLevel = $this->nativesession->get( 'userLevel' );
      ...
      $subtype = $this->input->post('subtype_id');
    ...
    $userLevel = $this->nativesession->get( 'userLevel' );
      ...
      function ajax_trainingSubType()
      {
        $parentid = $_GET['type_id'];

        $type = $this->courses_data->getSubTypes($parentid);
        //var_dump($type);
