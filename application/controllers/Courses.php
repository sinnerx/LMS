...
function index()
  ...
  {
    $list = $this->coursemdata->get_datatables();
    $data = array();
    $no = $_POST['start'];
    ...
    $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->coursemdata->count_all(),
            "recordsFiltered" => $this->coursemdata->count_filtered(),
            "data" => $data,
        );
