...
//alan
private function _get_datatables_query_ALAN($search = null, $order = null)
  {
  ...
  function get_datatables($length = null, $start = null, $search = null, $order = null)
  {
    //$ii = $_POST['order'];
    //$this->_get_datatables_query();
    //alan
    $this->_get_datatables_query_ALAN($search, $order);
    //alan
      if($length != -1)
