...
<head>  
 ...
 <div class="m-b-md">
        ...
        <a href="<?php echo base_url(); ?>packages/insert/"><button class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Choose Package</button></a>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('packages/ajax_list')?>",
            "type": "POST"
        },
