...
<head>  
        ...
        <a href="<?php echo base_url(); ?>package/insert/"><button class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add Package</button></a>
...
function edit_person(packageid)
{
    ...
    $.ajax({
        url : "<?php echo site_url('package/ajax_edit/')?>/" + packageid,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('package/ajax_update')?>";
    }
