...
<head>  
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/icon.css" type="text/css" />
    ...
    <section id="content">
          <section class="vbox">
            <section class="scrollable padder">
              ...
              <section class="panel panel-default">
                ...
                <form method="post" class="form-horizontal" action="<?php echo base_url() ?>module/module_data">
                     <div class="form-group">
                               ...
                               <input type="hidden" name="packageid" class="form-control" value="<?php echo $module['packageid']; ?>"disabled> -->
                               </div>
                               </div> 
          ...
          <select name="a_" id="multiselect" class="form-control" size="8" multiple="multiple">
             <?php foreach ($group as $row):{?><option value="<?php echo $row->id;?> " data-position="1"><?php echo $row->name;?></option> <?php } endforeach ?>
          </select>
        </div>
        ...
        <div class="col-sm-2">
         ...
         <div class="col-sm-5">
          ...
          <select name="moduleid" id="multiselect_to" class="form-control" size="8" multiple="multiple">
           <?php foreach ($groupp as $row):{?><option value="<?php echo $row->id;?> " data-position="1"><?php echo $row->name;?></option><?php } endforeach ?>
         </select>
         </div>
