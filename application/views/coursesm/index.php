...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('courses/ajax_list')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('courses/ajax_add')?>";
    } else {
        url = "<?php echo site_url('courses/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('courses/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
