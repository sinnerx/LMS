...
<!-- <section id="content">
 ...
 <!-- div class="m-b-md">
        ...
        <a href="<?php echo base_url(); ?>question/insert/"><button class="btn btn-success" type="submit"><i class="glyphicon glyphicon-plus"></i> Add Question</button></a>
...
function edit_person(q_id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('question/ajax_edit/')?>/" + q_id,
        type: "GET",
        dataType: "JSON",
...
function delete_person(q_id)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('question/ajax_delete')?>/"+q_id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
